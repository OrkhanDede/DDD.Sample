...
namespace Marketplace.Tests.Domain
{
    public class ClassifiedAd_Publish_Spec
    {
        ...
        [Fact]
        public void
            Can_publish_a_valid_ad()
        {
            _classifiedAd.SetTitle(ClassifiedAdTitle.FromString("Test_ad"));
        ...
        [Fact]
        public void
            Cannot_publish_with_zero_price()
        {
            _classifiedAd.SetTitle(
                ClassifiedAdTitle.FromString("Test ad"));
            _classifiedAd.UpdateText(
