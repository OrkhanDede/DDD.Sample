...
namespace Marketplace.Tests.Domain
{
    public class MoneyTest
    {
        ...
        [Fact]
        public void
            Two_of_same_amount_but_differentCurrencies_should_not_be_equal()
        {
            var firstAmount = Money.FromDecimal(5, "EUR", CurrencyLookup);
        ...
        [Fact]
        public void
            FromString_and_FromDecimal_should_be_equal()
        {
        ...
        [Fact]
        public void
            Sum_of_money_gives_full_amount()
        {
        ...
        [Fact]
        public void 
            Throws_on_adding_different_currencies()
        {
